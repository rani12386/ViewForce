namespace ViewForce.Reports.UI.Entity
{
    using ViewForce.Reports.Infrastructure;

    /// <summary>
    /// InternetSalesEntity class which contains the UI field members and which is derived from the ViewModelBase to notify the fields.
    /// </summary>
